...
ShortestPathTree*
gShortestPathTree( Graph* self, char *from, char *to, State* init_state, WalkOptions* options, uint64_t maxtime, int hoplimit, uint64_t weightlimit );

ShortestPathTree*
gShortestPathTreeRetro( Graph* self, char *from, char *to, State* init_state, WalkOptions* options, uint64_t mintime, int hoplimit, uint64_t weightlimit );

//direction specifies forward or retro routing
State*
gShortestPath( Graph* self, char *from, char *to, State* init_state, int direction, long *size, WalkOptions* options, uint64_t timelimit, int hoplimit, uint64_t weightlimit );
